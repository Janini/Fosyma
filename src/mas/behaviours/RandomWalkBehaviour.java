...
public class RandomWalkBehaviour extends TickerBehaviour{
	...
	public RandomWalkBehaviour (ExploAgent myagent) {
		super(myagent, 100);
		//super(myagent);
	}
	...
	public void onTick() {
		...
		if (myPosition!=""){
			...
			if (!vus.contains(myPosition))
				vus.add(myPosition);
			System.out.println("Salut, je suis "+this.myAgent.getLocalName()+" en "+myPosition);
			System.out.println(this.myAgent.getLocalName()+": J'ai dejà vu : "+vus);
			List<Couple<String,List<Attribute>>> lobs=((mas.abstractAgent)this.myAgent).observe();//myPosition
			//System.out.println(this.myAgent.getLocalName()+" -- list of observables: "+lobs);
			System.out.println("Je suis en "+myPosition);
